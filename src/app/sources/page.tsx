...
export default function SourcesPage() {
  return <div className="page">
    <div className="page-heading"><span className="eyebrow">Transparencia</span><h1>Fuentes y metodología</h1><p>Cada dato cambiante conserva su procedencia y fecha. El score de counter combina interacciones mecánicas, revisión competitiva y calibración del parche; no representa un porcentaje de victoria observado.</p></div>
