...
export default function LiveReviewPage() {
  return <div className="page">
    <div className="page-heading">
      <span className="eyebrow">Brawl Draft Lab · Coach v0.19</span>
      <h1>Auto Review + Entrenador</h1>
      <p>Analiza una partida en directo, graba o importa el vídeo completo y convierte cada revisión en decisiones concretas para mejorar la siguiente partida.</p>
    </div>
