...
export default function Home() {
  ...
  const currentMetaCore = ["Wendy", "Amber", "Shade", "Gus", "El Primo", "R-T"]
  ...
  return <div className="page home-dashboard-v230">
    <section className="hero hero-v2">
      <div className="hero-copy-v230">
        <span className="hero-badge">META U69 · BALANCE 16/09</span>
        <h1>Gana el draft<br /><em>antes de empezar.</em></h1>
        <p>Un centro competitivo para decidir mapa, bans, first pick, counters y respuesta al draft rival. El motor ya incorpora el mantenimiento del 16/09 y aplica una calibración provisional que separa el cambio oficial del ruido de las primeras horas.</p>
        ...
        <div className="hero-live-strip-v230" aria-label="Estado de la base competitiva">
          ...
          <div><strong>16/09</strong><span>Balance recalibrado</span></div>
        </div>
      </div>
      <div className="hero-roster" aria-hidden="true">
        ...
        <BrawlerPortrait name="Amber" className="hero-portrait hero-portrait-three" priority />
    ...
    <div className="section-title spaced"><div><span className="eyebrow">Señal competitiva · 16/09</span><h2>Núcleo provisional tras el balance</h2></div><Link href="/meta">Ver cambios, datos y criterio →</Link></div>
    <div className="card-grid brawler-grid">{currentMetaCore.map((brawler) => <BrawlerCard key={brawler.name} brawler={brawler} />)}</div>

    <section className="cta-panel">
      <div><span className="eyebrow">Matchup Lab</span><h2>Lee el pick rival y encuentra la respuesta que mejor encaja en ese draft.</h2><p>El motor combina matchup mecánico, respuesta inversa y calibración post-balance; el score es heurístico, no un porcentaje de victoria observado.</p></div>
