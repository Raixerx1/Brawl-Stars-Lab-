...
export default function AppShell({ children }: { children: ReactNode }) {
  ...
  return <div className="app-shell">
    <aside className={`sidebar ${open ? "open" : ""}`}>
      ...
      <div className="sidebar-note"><b>Base v0.21.6</b><span>Picks: micro persistente v2</span><span>Recomendaciones sin solapamientos · análisis grande</span></div>
    </aside>
    <main>
      <header className="topbar">
        <button className="menu-button" onClick={() => setOpen(!open)}>☰</button>
        <div><b>De Mítico a Legendario</b><span>Windstock · Draft legible · voz persistente · vídeo consciente del equipo</span></div>
