...
export default function AppShell({ children }: { children: ReactNode }) {
  ...
  return <div className="app-shell">
    <aside className={`sidebar ${open ? "open" : ""}`}>
      ...
      <div className="sidebar-note"><b>Base v0.25.0</b><span>Update 69 · 69.230 live</span><span>Analyzer v0.25 · Draft Engine 2.0</span></div>
    </aside>
    <main>
      <header className="topbar">
        <button className="menu-button" onClick={() => setOpen(!open)}>☰</button>
        <div><b>Competitive Draft Center</b><span>Update 69 live · analyzer adaptativo v0.25 · counters recalculados</span></div>
