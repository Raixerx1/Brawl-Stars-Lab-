...
expect(serviceWorker.includes('kanna-draft-v0332'), "La caché PWA no fuerza la actualización móvil");

console.log("Auditoría móvil v0.33.2 · base de layout v0.32.1");
