...
expect(pkg.version === "0.32.1", `Versión inesperada: ${pkg.version}`);
expect(pkg.scripts?.["audit:mobile"] === "node scripts/audit-mobile-layout-v321.mjs", "La auditoría móvil no está conectada");
expect(serviceWorker.includes('brawl-draft-lab-v0321'), "La caché PWA no fuerza la actualización móvil");

console.log("Auditoría móvil v0.32.1");
